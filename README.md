...
| Number of commits by different people in GH |                                                      | 3      |
| Issues reports                     |                                                                  | 1      |
| Issues are being closed            |                                                                  | 2 (35 closed but 9 open) |
| DOI badge: exists in GH           |                                                                  | 3      |
| **Documentation**                  |                                                              |        |
| Docs: doco generated, format not ugly in GH |                                                       | 3      |
...
| Test cases are routinely executed - E.g. travis-com.com or github actions or something | 1 (can’t find evidence) |
| **Collaboration**                  |                                                              |        |
| The files CONTRIBUTING.md lists coding standards and lots of tips on how to extend the system without screwing things up | 3 |
...
| **Workload Distribution**          | Workload is spread over the whole team (one team member is often X times more productive than the others). | 1      |
| **GitHub Evidence**                |                                                              |        |
...
| Docs: short video, animated, hosted on your repo. That convinces people why they want to work on your code | 1 (no incentive to work on code - only marketing) |
| **Code Quality**                   |                                                              |        |
| Use of version control tools       |                                                                  | 3      |
| Use of style checkers - config files in GH showing your config | 0 |
| Use of code formatters - config files in GH showing your this formatter's config | 0   |
